...
package com.yandex.darkside.views.idepreview
...
import com.yandex.darkside.R
import com.yandex.darkside.cookies.dp
import com.yandex.darkside.views.Ui
import com.yandex.darkside.views.layouts.lParams
import com.yandex.darkside.views.matchParent
import com.yandex.darkside.views.textView
import com.yandex.darkside.views.ui
 ...
 *
 * ```xml
 * <com.yandex.darkside.views.idepreview.UiPreView
    ...
    init {
        ...
        try {
            if (createUi == null) {
                ...
                addView(createUi(this.context).root, lParams(matchParent, matchParent))
            }
